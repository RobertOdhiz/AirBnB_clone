#!/usr/bin/python3
"""
Tests the BaseModel class using unittests
"""
import os
import models
import unittest
...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_two_models_unique_ids(self):
        ...
        self.assertNotEqual(base_model1.id, bm2.id)

    def test_two_models_different_created_at(self):
        base_model1 = BaseModel()
        sleep(0.05)
        base_model2 = BaseModel()
        self.assertLess(base_model1.created_at, bm2.created_at)

    def test_two_models_different_updated_at(self):
        base_model1 = BaseModel()
        sleep(0.05)
        base_model2 = BaseModel()
        self.assertLess(base_model1.updated_at, bm2.updated_at)
...
class TestBaseModel_to_dict(unittest.TestCase):
    ...
    def test_contrast_to_dict_dunder_dict(self):
        base_model = BaseModel()
        self.assertNotEqual(base_model.to_dict(), bm.__dict__)
